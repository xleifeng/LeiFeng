...
const { daemonRegistry } = require('../plugins/registry.cjs');
...
export async function main(argv = process.argv.slice(2)) {
  ...
  if (profile === 'bridge-host') {
    const { createBridgePluginRegistry } = require('../../../packages/webseed-bridge/src/profile-plugins.cjs');
    const { bridgePatch } = require('../../../packages/webseed-bridge/src/main.js');
